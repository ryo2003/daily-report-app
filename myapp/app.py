...
make_event = st.Page(page="pages/make_event.py",title="イベントの作成",icon=":material/edit_calendar:")
...
pg = st.navigation([top_page, my_profile,search,chat,create_by_hand,login,event,seenippo,seemynippo,edit,make_event])
